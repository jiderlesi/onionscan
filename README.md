...
[![Build Status](https://travis-ci.org/jiderlesi/onionscan.svg?branch=onionscan-0.2)](https://travis-ci.org/jiderlesi/onionscan) [![Go Report Card](https://goreportcard.com/badge/github.com/jiderlesi/onionscan)](https://goreportcard.com/report/github.com/jiderlesi/onionscan)
...
See <a href="https://github.com/jiderlesi/onionscan/wiki">the wiki</a> for guidance.

### Grab with go get

`go get github.com/jiderlesi/onionscan`

### Compile/Run from git cloned source

Once you have cloned the repository into somewhere that go can find it you can
run `go install github.com/jiderlesi/onionscan` and then run the binary in `$GOPATH/bin/onionscan`.

Alternatively, you can just do `go run github.com/jiderlesi/onionscan.go` to run without compiling.
